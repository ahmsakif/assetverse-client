...
[![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen?style=for-the-badge)](https://assetverse-bitvotion.netlify.app/)
[![Repo](https://img.shields.io/badge/GitHub-Repo-blue?style=for-the-badge)](https://github.com/ahmsakif/assetverse-client.git)
...
1.  **Clone the repository**
    ...
    ```bash
    git clone [https://github.com/your-username/assetverse.git](https://github.com/ahmsakif/assetverse-client.git)
    cd assetverse
    ```
...
<p align="center">
  Built with ❤️ by <a href="https://github.com/your-username">Sakif Ahmed</a>
</p>
