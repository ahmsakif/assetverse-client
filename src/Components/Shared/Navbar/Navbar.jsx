...
const Navbar = () => {
    ...
    return (
        ...
        <div className={`fixed top-0 w-full z-50 transition-all duration-500 border-b ${scrolled
            ...
            <div className="flex flex-col w-full">
                {/* Navbar Content */}
                <div className="w-full navbar max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex-none gap-4 ml-4">
                        {user ? (
                            ...
                            <Link
                                to="/login"
                                className={`btn rounded-xl px-6 font-bold border-none transition-all shadow-md ${scrolled
